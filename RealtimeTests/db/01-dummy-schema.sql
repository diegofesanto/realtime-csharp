...
CREATE TABLE public.revit_events
(
    id        int generated by default as identity,
...
ALTER publication supabase_realtime add table public.revit_events;

insert into "public"."revit_events" ("id", "event_name", "info", "secret_key", "from_frontend")
values (1, 'inserted', 'info', '61fa867d-a98c-41b1-a202-5588f879a0cc', 1);
insert into "public"."revit_events" ("id", "event_name", "info", "secret_key", "from_frontend")
values (2, 'inserted', 'info', '2e2a119d-0976-430f-a6ef-e827ff1ab364', 1);
